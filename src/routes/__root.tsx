...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Submit and manage service requests on board Aura Seas." },
      { name: "twitter:description", content: "Submit and manage service requests on board Aura Seas." },
